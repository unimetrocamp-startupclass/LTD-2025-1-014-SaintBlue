  ...
  return (
    <StyledWrapper>
        <label id="theme-toggle-button">
            ...
            type="checkbox"
            id="toggle"
            checked={isDarkMode} // Sincroniza com o estado global
            onChange={toggleDarkMode} // Alterna o modo ao clicar
            />
            <svg  className="switch" viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
            <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
                ...
                <g className={`${!isDarkMode ? "ativo" : ""}`} data-name="sun" id="sun">
                ...
                <g  className={`${isDarkMode ? "ativo" : ""}`} data-name="moon" id="moon">
...
const StyledWrapper = styled.div`
  ...
  #theme-toggle-button {
    ...
    width: 4em;     /* Ajusta a largura do botão */
    margin-top: 3px;
    height: 2.5em;    /* Define a altura do botão (ajustável conforme necessário) */
    cursor: pointer;
  }
  ...
  /* Ajuste de transições e animações */
  #container,
  #patches,
  #stars,
  #button,
